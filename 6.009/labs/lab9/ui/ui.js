...
var TOWER_INFO = {
    ...
    'Demon': {'price': 100, 'texture': '1f479'},
    'VHS': {'price': 20, 'texture': '1f4fc'},
    'TraineeZookeeper': {'price': 50, 'texture': '1f476'},
    'CrazyZookeeper': {'price': 100, 'texture': '1f61c'},
    'SplashZookeeper': {'price': 200, 'texture': '1f608'}
}
...
function init_gui() {
    ...
    invoke_rpc("/ls", {"path":"cases/"}, 0, function(loaded) {
        ...
        for (var i in loaded) {
            ...
            //Booleans:
            let showTestClass = (testClass !== undefined && testClass >= 4);
